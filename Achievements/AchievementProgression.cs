...
namespace TerrariaAchievementLib.Achievements
{
    ...
    public class AchievementProgression
    {
        ...
        {
            { ProgressionState.Hardmode, [ItemID.AncientHorn, ItemID.WolfMountItem, ItemID.BlessedApple, ItemID.ScalyTruffle, ItemID.QueenSlimeMountSaddle, ItemID.ShrimpyTruffle, ItemID.WitchBroom, ItemID.WallOfFleshGoatMountItem, ItemID.PirateShipMountItem, ItemID.SpookyWoodMountItem, ItemID.SantankMountItem] },
            { ProgressionState.PostMechanicalTrio, [] },
        ...
        {
            { ProgressionState.Hardmode, [BuffID.BasiliskMount, BuffID.WolfMount, BuffID.UnicornMount, BuffID.PigronMount, BuffID.QueenSlimeMount, BuffID.CuteFishronMount, BuffID.WitchBroom, BuffID.WallOfFleshGoatMount, BuffID.PirateShipMount, BuffID.SpookyWoodMount, BuffID.SantankMount] },
            { ProgressionState.PostMechanicalTrio, [] },
