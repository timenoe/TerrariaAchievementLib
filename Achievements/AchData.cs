...
namespace TerrariaAchievementLib.Achievements
{
    ...
    public class AchData
    {
        ...
        {
            { ProgressionState.Hardmode, [ItemID.CobaltPickaxe, ItemID.CobaltDrill, ItemID.PalladiumPickaxe, ItemID.PalladiumDrill, ItemID.MythrilPickaxe, ItemID.MythrilDrill, ItemID.OrichalcumPickaxe, ItemID.OrichalcumDrill, ItemID.AdamantitePickaxe, ItemID.AdamantiteDrill, ItemID.TitaniumPickaxe, ItemID.TitaniumDrill, ItemID.PickaxeAxe, ItemID.Drax, ItemID.PalladiumWaraxe, ItemID.PalladiumChainsaw, ItemID.MythrilWaraxe, ItemID.MythrilChainsaw, ItemID.OrichalcumWaraxe, ItemID.OrichalcumChainsaw, ItemID.AdamantiteWaraxe, ItemID.AdamantiteChainsaw, ItemID.TitaniumWaraxe, ItemID.TitaniumChainsaw, ItemID.PickaxeAxe, ItemID.BloodHamaxe, ItemID.RodofDiscord] },
            { ProgressionState.PostMechanicalTrio, [ItemID.ChlorophytePickaxe, ItemID.ChlorophyteDrill, ItemID.ChlorophyteGreataxe, ItemID.ChlorophyteChainsaw] },
