...
namespace TerrariaAchievementLib.Achievements.Conditions
{
    ...
    public class CustomItemCraftCondition : CustomIdCondition
    {
        ...
        /// </summary>
        protected static readonly Dictionary<int, List<CustomItemCraftCondition>> _listeners = [];
        ...
        private CustomItemCraftCondition(ConditionRequirements reqs, int id) : base(CustomName, reqs, [id]) => Listen();
        ...
        private CustomItemCraftCondition(ConditionRequirements reqs, int[] ids) : base(CustomName, reqs, ids) => Listen();
