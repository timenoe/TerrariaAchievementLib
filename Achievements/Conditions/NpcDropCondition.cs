...
namespace TerrariaAchievementLib.Achievements.Conditions
{
    ...
    public class NpcDropCondition : AchIdCondition
    {
        ...
        private NpcDropCondition(ConditionReqs reqs, int npcId, int itemId) : base($"{CustomName}_{string.Join(",", npcId)}", reqs, [itemId]) => Listen(this, npcId);
        ...
        private NpcDropCondition(ConditionReqs reqs, int npcId, int[] itemIds) : base($"{CustomName}_{string.Join(",", npcId)}", reqs, itemIds) => Listen(this, npcId);
        ...
        public static CustomAchievementCondition Drop(ConditionReqs reqs, int npcId, int itemId) => new NpcDropCondition(reqs, npcId, itemId);
        ...
        /// <param name="itemIds">Item IDs to listen for</param>
        /// <returns>NPC item drop achievement condition</returns>
        public static CustomAchievementCondition DropAny(ConditionReqs reqs, int npcId, params int[] itemIds) => new NpcDropCondition(reqs, npcId, itemIds);
        ...
        public static List<CustomAchievementCondition> DropAll(ConditionReqs reqs, int npcId, params int[] itemIds)
        {
        ...
        private static void CustomAchievementsHelper_OnNpcDrop(Player player, int npcId, int itemId)
        {
